...
namespace PharmacyManagementSystem
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IGenericRepository<PatientModel>, GenericRepository<PatientModel>>();
            services.AddScoped<IGenericRepository<DoctorModel>, GenericRepository<DoctorModel>>();
